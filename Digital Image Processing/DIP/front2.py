...
import cv2
import numpy as np
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QFileDialog, QMessageBox
...
def BgRemmover():
    st.info("Background Remover")

def ImageToSketch():
    st.warning("Image To Sketch")

def function4():
    st.error("This Service is Comming Soon !")

def function5():
    st.error("FComming Soon !", icon="🔔")
...
def main():
    ...
    with col1:  # First column
        st.image("/Users/hunaragrawal/Downloads/Digital Image Processing/images-3.jpeg", caption="Colorization")
        if st.button("Start Colorizing", key='1'):
            # Call the main function from the Colorize module
            ImageProcessing()
            

    with col2:  # Second column
        st.image("/Users/hunaragrawal/Downloads/Digital Image Processing/images-2.jpeg", caption="Background Remover")
        if st.button("Start Processing", key='2'):
            # Call the main function from the BgRemove module
            ImageProcessing()
    ...
    with col3[0]:  # Center column
        st.image("/Users/hunaragrawal/Downloads/Digital Image Processing/images.jpeg", caption="Image To Sketch")
        if st.button("Start Converting", key='3'):
            # Call the main function from the Sketch module
            ImageProcessing()
    ...
    with col4:
        st.image("/Users/hunaragrawal/Downloads/Digital Image Processing/images-4.jpeg", caption="Image Restoration")
        if st.button("Comming Soon !", key='4'):
            function4()

    with col5:
        st.image("/Users/hunaragrawal/Downloads/Digital Image Processing/images-5.jpeg", caption="Steganography")
        if st.button("Comming Soon !", key='5'):
            function4()
...
class ImageProcessingWindow(QMainWindow):
    ...
    def execute_colorization(self):
        self.colorization_window = ImageColorizationWindow()
        self.colorization_window.show()

    def execute_sketch(self):
        self.Image_to_sketch_window = ImageToSketchWindow()
        self.Image_to_sketch_window.show()

    def execute_remover(self):
        self.background_remova_window = BgRemmoveWindow()
...
class ImageColorizationWindow(QMainWindow):
    def __init__(self):
        super().__init__()
...
class ImageToSketchWindow(QMainWindow):
    def __init__(self):
        super().__init__()
...
class BgRemmoveWindow(QMainWindow):
    def __init__(self):
        super().__init__()
